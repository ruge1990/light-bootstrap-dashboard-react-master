...
function Classes(props) {
  ...
  const handleCreateClass = e => {
    ...
    axios.post(api + '/class/create/', {"classname": classname},
    {
      headers: {
        Authorization: getToken()
      }
...
function Class({_class, ...props}) {
  ...
  const handleAssignPupil = e => {
    ...
    axios.post(api + '/class/pupil/contain', {
      "pupilID": pupilID,
    },{
      headers: {
        Authorization: getToken()
      ...
      if(response.data._id) {
        ...
        axios.post(api + '/class/' + response.data._id + '/pupil/assign', {
          "pupilID": pupilID,
          "assign": 'false'
        },
        {
    ...
    axios.post(api + '/class/' + _class._id + '/pupil/assign', {
      "pupilID": pupilID,
      "assign": 'true'
    },
    {
  ...
  const handleCreateSubject = e => {
    ...
    axios.post(api + '/subject/create/', state,
    {
      headers: {
        Authorization: getToken()
      }
  ...
  const handleUpdateClass = e => {
    ...
    axios.put(api + '/class/update/' + _class._id, {"classname": classname},
    {
      headers: {
        Authorization: getToken()
      }
  ...
  const handleDeleteClass = async ()=>{
    ...
    for( const subject of _class.subjects) {
      ...
      axios.delete(api + '/subject/delete/' + subject.subjectID,
      {
        headers: {
          Authorization: getToken(),
          classID: _class._id
      ...
      axios.delete(api + '/subject/archive/' + subject.subjectID,
      {
        headers: {
          Authorization: getToken(),
        }
    ...
    axios.delete(api + '/class/delete/' + _class._id,
    {
      headers: {
        Authorization: getToken(),
      }
            ...
            <Form.Group>
              ...
              >
                ...
                {pupils.map((pupil, index) => (
                  <option value={pupil._id} key={index}>{pupil.username}</option>
                ))}
...
function Pupil({pupil, ...props}) {
  ...
  const getPupilName = async () => {
    //setIsLoading(true);
    await axios.get(api + '/user/' + pupil.pupilID, 
    {
      headers: {
        Authorization: getToken()
      }
  ...
  const handleDeassignPupil = e => {
    ...
    axios.post(api + '/class/' + classID + '/pupil/assign', {
