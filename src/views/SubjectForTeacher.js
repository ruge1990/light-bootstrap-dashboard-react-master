...
function SubjectForTeacher({subject, ...props}) {
  ...
  const getPupil = async () => {
    if(subject.archived){
      for (const test of subject.tests) {
        ...
        await axios.get(api + '/test/' + test.testID, {
          headers: {
  ...
  const getPupilAndGrade = async () => {
    ...
    for (const pupil2 of [...pupils]) {
      ...
      for (const test of subject.tests) {
        //await axios.get('http://localhost:5000/api/v1/user/list', {
        await axios.get(api + '/test/' + test.testID + '/grade/' + pupil.pupilID, {
          headers: {
            Authorization: getToken(),
          }
        })
  ...
  const handleCreateTest = e => {
    ...
    axios.post(api + '/test/create/', state,
    {
      headers: {
        Authorization: getToken()
      }
...
function Test({test, ...props}) {
  ...
  const handleCreateGrade = e => {
    ...
    axios.post(api + '/test/' + test.testID + '/grade/create/', newGrade,
    {
      headers: {
        Authorization: getToken()
      }
  ...
  const handleUpdateTest = e => {
    ...
    axios.put(api + '/test/update/' + test.testID, state,
    {
      headers: {
        Authorization: getToken()
      }
  ...
  const handleDeleteTest = async ()=>{
    ...
    axios.delete(api + '/test/delete/' + test.testID,
    {
      headers: {
        Authorization: getToken(),
...
function Grade({grade, ...props}) {
  ...
  const getPupilName = async () => {
    ...
    await axios.get(api + '/user/' + state.pupilID, {
      headers: {
        Authorization: getToken(),
      }
    })
  ...
  const handleUpdate = async (e) => {
    ...
    axios.put(api + '/test/' + props.testID + '/grade/update/', state,
    {
      headers: {
        Authorization: getToken()
      }
  ...
  const handleDelete = async ()=>{
    ...
    axios.delete(api + '/test/'  + props.testID + '/grade/delete',
    {
      headers: {
        Authorization: getToken(),
