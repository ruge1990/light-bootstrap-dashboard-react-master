...
function SubjectForPupil({subject, ...props}) {
  ...
  const getGrade = async () => {
      ...
      for (const test of tests) {
        ...
        await axios.get(api + '/test/' + test.testID + '/grade/' + props.history.location.state.userID, {
          headers: {
            Authorization: getToken(),
          }
        })
...
function Test({testID, ...props}) {
  ...
  const getGrade = async () => {
    ...
    await axios.get(api + '/test/' + testID + '/grade/' + props.history.location.state.userID, {
      headers: {
        Authorization: getToken(),
      }
    })
